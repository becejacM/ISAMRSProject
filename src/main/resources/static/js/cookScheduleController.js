(function () {
    ...
    CookScheduleController.$inject = ['calendarConfig','$location','UserService','RestaurantService', 'AuthenticationService', '$rootScope', 'FlashService', '$scope'];
    function CookScheduleController(calendarConfig, $location, UserService,RestaurantService, AuthenticationService, $rootScope, FlashService, $scope) {
        var vm = this;
