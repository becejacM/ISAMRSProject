(function () {
    ...
    WaiterScheduleController.$inject = ['calendarConfig','$location','UserService','RestaurantService', 'AuthenticationService', '$rootScope', 'FlashService', '$scope'];
    function WaiterScheduleController(calendarConfig, $location, UserService,RestaurantService, AuthenticationService, $rootScope, FlashService, $scope) {
        var vm = this;
