(function () {
    ...
    angular
        .module('app')
        .controller('WaiterTablesController', WaiterTablesController);

    WaiterTablesController.$inject = ['$location','UserService', 'RestaurantService','AuthenticationService', '$rootScope', 'FlashService'];
    function WaiterTablesController($location,UserService,RestaurantService,AuthenticationService, $rootScope, FlashService) {
        var vm = this;
