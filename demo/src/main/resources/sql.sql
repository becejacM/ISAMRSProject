...
INSERT INTO `mrsisa_project`.`app_users` (`id`, `email`, `first_name`, `last_name`, `password`, `image`, `role`, `verified`, `login`, `message`, `token`, `broj_poseta`) VALUES('7', 'guest1@gmail.com', 'guest1', 'guest1', '12345', 'pictures/user.png', 'guest', 'yes', 'no', null, null, '0');
INSERT INTO `mrsisa_project`.`app_users` (`id`, `email`, `first_name`, `last_name`, `password`, `image`, `role`, `verified`, `login`, `message`, `token`, `broj_poseta`) VALUES('8', 'guest2@gmail.com', 'guest2', 'guest2', '12345', 'pictures/user.png', 'guest', 'yes', 'no', null, null, '0');
INSERT INTO `mrsisa_project`.`app_users` (`id`, `email`, `first_name`, `last_name`, `password`, `image`, `role`, `verified`, `login`, `message`, `token`, `broj_poseta`) VALUES('9', 'guest3@gmail.com', 'guest3', 'guest3', '12345', 'pictures/user.png', 'guest', 'yes', 'no', null, null, '0');
